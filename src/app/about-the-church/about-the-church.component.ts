...
@Component({
  selector: 'app-about-the-church',
  templateUrl: './about-the-church.component.html',
  styleUrls: ['./about-the-church.component.css']
})
export class AboutTheChurchComponent implements OnInit {
